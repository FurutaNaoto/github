...
function footerUpdate() {
  ...
  + `<div class="">© 2025 UNIONTEC Co.,Ltd. & Furuta Naoto</div>`
  + `</div>`;
  //
...
//////////////////////////
//////////////////////////
//ホームのページのhtmlファイルパスを作成する。
var HomeHtmlPath = decodeURI(window.location.href).split('UtHelpHome')[0] + 'UtHelpHome/UtHelpHome.html';

var header_innerHTML = document.getElementById('header');
header_innerHTML.innerHTML = `
<div class="headers MS_idleX">
  <a target="_self" href="${HomeHtmlPath}">
